...
```{r}
img_paths <- c("../ext/images/koalas/KP5.jpg", 
...
koala.df <- lubridate::ymd_hms(koala.df$recordedOn, tz = "Australia/Queensland")
...
```{r}
# Define image paths
img_paths <- c("../ext/images/reef/100030039.jpg", 
...
```{r}
# Define image paths
img_paths <- c("../ext/images/jaguars/WP14_360_002.jpg", 
