...
multivariable_question_scene <- function(the_question, answer_1, answer_2, answer_3, answer_4, img_paths, IPv4_ADDRESS, message_height = 1.5){
  ...
  canvas_3d <- a_entity(.tag = "sky",
                        .js_sources = list("https://cdn.jsdelivr.net/gh/ACEMS/r2vr@interactions/inst/js/button_controls.js", "https://cdn.jsdelivr.net/gh/ACEMS/r2vr@interactions/inst/js/selection_interactions.js"),
                        id = "canvas3d",
                        class = img_paths[1],
                        src = image1,
                        rotation = c(0, 0, 0),
